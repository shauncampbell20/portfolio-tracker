...
from portfolio_tracker.helpers import get_positions_table, cache
...
def index():
    ...
    if g.user:
        ...
        positions_table = get_positions_table(df)
    return render_template('main/index.html',table=positions_table)